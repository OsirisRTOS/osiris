...
fn format_memory_section(regions: &[(&str, u64, u64)]) -> String {
    ...
    indoc::formatdoc! {"
        /* This file is @generated by dtgen. Do not edit. */
        MEMORY {{
        {regions}
        }}
    ", regions = regions}
...
fn coalesce_regions<'a>(name: &'a str, regions: Vec<(&'a str, u64, u64)>) -> Result<Option<(&'a str, u64, u64)>, String> {
    regions
        .clone()
        .into_iter()
...
pub fn generate_ld(dt: &DeviceTree) -> Result<String, String> {
    ...
    Ok(format_memory_section(&regions))
}
