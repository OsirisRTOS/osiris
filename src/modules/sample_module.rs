...
// Below, stubs of the three types of methods can be found. Note that the signature needs to match the one provided in the samples and especially that the return type of the kernelmodule_call needs to be at most register sized.
